...
export default {
  ...
  data() {
    return {
      ...
      currentDay: "",
      MoSitUps: localStorage.getItem("MositUps"),
      DiSitUps: localStorage.getItem("DisitUps"),
      MiSitUps: localStorage.getItem("MisitUps"),
      DoSitUps: localStorage.getItem("DositUps"),
      FrSitUps: localStorage.getItem("FesitUps"),
      SaSitUps: localStorage.getItem("SasitUps"),
      SoSitUps: localStorage.getItem("SositUps"),
    };
  },
  created() {
    this.checkDay();
